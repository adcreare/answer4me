...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, listAllRecordings()];
                case 1:
                    listOfRecordings = _a.sent();
                    listOfNotifications = combineRecordingListToNotificationList(listOfRecordings);
                    listOfNotifications[];
                    // TODO
...
function processCalls(listOfNotifications) {
}
function addCallerInformation(notification) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getCallInformation(notification.callSid)];
                case 1:
                    callInformation = _a.sent();
                    return [2 /*return*/];
            }
        });
    });
}
function getCallInformation(callSid) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
function combineRecordingListToNotificationList(listOfRecordings) {
